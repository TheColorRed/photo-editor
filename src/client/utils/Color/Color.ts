import { Blend, BlendType } from './Blend'
    ...
    public static blend(color1: Color, color2: Color, blendType: BlendType): Color {
        ...
        switch (blendType) {
            case BlendType.Normal:
                r = Blend.normal(color1.r, color2.r);
                g = Blend.normal(color1.g, color2.g);
                b = Blend.normal(color1.b, color2.b);
                a = Blend.normal(color1.a, color2.a);
                break;
            case BlendType.Lighten:
                r = Blend.lighten(color1.r, color2.r);
                g = Blend.lighten(color1.g, color2.g);
                b = Blend.lighten(color1.b, color2.b);
                a = Blend.lighten(color1.a, color2.a);
                break;
            case BlendType.Darken:
                r = Blend.darken(color1.r, color2.r);
                g = Blend.darken(color1.g, color2.g);
                b = Blend.darken(color1.b, color2.b);
                a = Blend.darken(color1.a, color2.a);
                break;
            case BlendType.Multiply:
                r = Blend.multiply(color1.r, color2.r);
                g = Blend.multiply(color1.g, color2.g);
                b = Blend.multiply(color1.b, color2.b);
                a = Blend.multiply(color1.a, color2.a);
                break;
            case BlendType.Average:
                r = Blend.average(color1.r, color2.r);
                g = Blend.average(color1.g, color2.g);
                b = Blend.average(color1.b, color2.b);
                a = Blend.average(color1.a, color2.a);
                break;
            case BlendType.Add:
                r = Blend.add(color1.r, color2.r);
                g = Blend.add(color1.g, color2.g);
                b = Blend.add(color1.b, color2.b);
                a = Blend.add(color1.a, color2.a);
                break;
            case BlendType.Subtract:
                r = Blend.subtract(color1.r, color2.r);
                g = Blend.subtract(color1.g, color2.g);
                b = Blend.subtract(color1.b, color2.b);
                a = Blend.subtract(color1.a, color2.a);
                break;
            case BlendType.Difference:
                r = Blend.difference(color1.r, color2.r);
                g = Blend.difference(color1.g, color2.g);
                b = Blend.difference(color1.b, color2.b);
                a = Blend.difference(color1.a, color2.a);
                break;
            case BlendType.Negation:
                r = Blend.negation(color1.r, color2.r);
                g = Blend.negation(color1.g, color2.g);
                b = Blend.negation(color1.b, color2.b);
                a = Blend.negation(color1.a, color2.a);
                break;
            case BlendType.Screen:
                r = Blend.screen(color1.r, color2.r);
                g = Blend.screen(color1.g, color2.g);
                b = Blend.screen(color1.b, color2.b);
                a = Blend.screen(color1.a, color2.a);
                break;
            case BlendType.Exclusion:
                r = Blend.exclusion(color1.r, color2.r);
                g = Blend.exclusion(color1.g, color2.g);
                b = Blend.exclusion(color1.b, color2.b);
                a = Blend.exclusion(color1.a, color2.a);
                break;
            case BlendType.Overlay:
                r = Blend.overlay(color1.r, color2.r);
                g = Blend.overlay(color1.g, color2.g);
                b = Blend.overlay(color1.b, color2.b);
                a = Blend.overlay(color1.a, color2.a);
                break;
            case BlendType.SoftLight:
                r = Blend.softLight(color1.r, color2.r);
                g = Blend.softLight(color1.g, color2.g);
                b = Blend.softLight(color1.b, color2.b);
                a = Blend.softLight(color1.a, color2.a);
                break;
            case BlendType.HardLight:
                r = Blend.hardLight(color1.r, color2.r);
                g = Blend.hardLight(color1.g, color2.g);
                b = Blend.hardLight(color1.b, color2.b);
                a = Blend.hardLight(color1.a, color2.a);
                break;
            case BlendType.ColorDodge:
                r = Blend.colorDodge(color1.r, color2.r);
                g = Blend.colorDodge(color1.g, color2.g);
                b = Blend.colorDodge(color1.b, color2.b);
                a = Blend.colorDodge(color1.a, color2.a);
                break;
            case BlendType.ColorBurn:
                r = Blend.colorBurn(color1.r, color2.r);
                g = Blend.colorBurn(color1.g, color2.g);
                b = Blend.colorBurn(color1.b, color2.b);
                a = Blend.colorBurn(color1.a, color2.a);
                break;
            case BlendType.LinearDodge:
                r = Blend.linearDodge(color1.r, color2.r);
                g = Blend.linearDodge(color1.g, color2.g);
                b = Blend.linearDodge(color1.b, color2.b);
                a = Blend.linearDodge(color1.a, color2.a);
                break;
            case BlendType.LinearBurn:
                r = Blend.linearBurn(color1.r, color2.r);
                g = Blend.linearBurn(color1.g, color2.g);
                b = Blend.linearBurn(color1.b, color2.b);
                a = Blend.linearBurn(color1.a, color2.a);
                break;
            case BlendType.LinearLight:
                r = Blend.linearLight(color1.r, color2.r);
                g = Blend.linearLight(color1.g, color2.g);
                b = Blend.linearLight(color1.b, color2.b);
                a = Blend.linearLight(color1.a, color2.a);
                break;
            case BlendType.VividLight:
                r = Blend.vividLight(color1.r, color2.r);
                g = Blend.vividLight(color1.g, color2.g);
                b = Blend.vividLight(color1.b, color2.b);
                a = Blend.vividLight(color1.a, color2.a);
                break;
            case BlendType.PinLight:
                r = Blend.pinLight(color1.r, color2.r);
                g = Blend.pinLight(color1.g, color2.g);
                b = Blend.pinLight(color1.b, color2.b);
                a = Blend.pinLight(color1.a, color2.a);
                break;
            case BlendType.HardMix:
                r = Blend.hardMix(color1.r, color2.r);
                g = Blend.hardMix(color1.g, color2.g);
                b = Blend.hardMix(color1.b, color2.b);
                a = Blend.hardMix(color1.a, color2.a);
                break;
            case BlendType.Reflect:
                r = Blend.reflect(color1.r, color2.r);
                g = Blend.reflect(color1.g, color2.g);
                b = Blend.reflect(color1.b, color2.b);
                a = Blend.reflect(color1.a, color2.a);
                break;
            case BlendType.Glow:
                r = Blend.glow(color1.r, color2.r);
                g = Blend.glow(color1.g, color2.g);
                b = Blend.glow(color1.b, color2.b);
                a = Blend.glow(color1.a, color2.a);
                break;
            case BlendType.Phoenix:
                r = Blend.phoenix(color1.r, color2.r);
                g = Blend.phoenix(color1.g, color2.g);
                b = Blend.phoenix(color1.b, color2.b);
                a = Blend.phoenix(color1.a, color2.a);
                break;
        }
